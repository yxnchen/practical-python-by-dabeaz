...
# It preserves the interpreter state. That means that you can go poking around after the crash. 
# Checking variable values and other state.
...
# You’ll sometimes see this mentioned in other debugging guides.
"""
import pdb
...
...
# 5 run under debugger
# You can also run an entire program under debugger.
"""
bash % python3 -m pdb someprogram.py
"""
# It will automatically enter the debugger before the first statement. 
# Allowing you to set breakpoints and change the configuration.
